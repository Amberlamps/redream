...
var Model = function(name, schema, redream) {
	...
	return (function() {
		...
		Document.prototype.findOneById = function(articleId, callback) {

			findOneById(_key, _schema, _redream.client, articleId, callback);

		};

		Document.prototype.findByArray = function(array, callback) {

			findByArray(_key, _schema, _redream.client, array, callback);

		};

		Document.prototype.findAll = function(callback) {

			findAll(_key, _schema, _redream.client, callback);

		};

		Document.prototype.findByKeyValue = function(key, value, callback) {
		...
		Document.prototype.findOne = function(query, callback) {
